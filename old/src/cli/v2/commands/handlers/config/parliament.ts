...
export const handleConfigParliament: CoreCommandHandler = async (ctx, args) => {
...
async function parliamentList(ctx: Parameters<CoreCommandHandler>[0]): Promise<CoreCommandResult> {
