...
| **J3** | Report a bug, the agent locates + fixes it on disk (run-to-confirm when E11 ships) | search_files/read_file/edit/apply_patch (E3); execute_code (E11) | ⏳ partial (skip exec until E11) | `test_j3_debug_script.py` |
...
| **J8** | Plan N consequential actions, approve as ONE batch, execute audited | consent batch (E0 + planning) | ⏳ partial | `test_j8_batch_approval.py` |
