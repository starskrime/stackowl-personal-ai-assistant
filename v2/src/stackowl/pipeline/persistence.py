...
def _build_messages(
    ...
    system = Message(
        ...
        content=(
            ...
            "ANY language — whether the agent actually DELIVERED the requested "
            "outcome, or whether it gave up, refused, apologized, or deferred "
            "WITHOUT exhausting the capabilities above. An agent that merely "
            "explains why it cannot proceed, asks the user to do the work, or "
            "stops after read-only steps has NOT delivered. Return ONLY a JSON "
