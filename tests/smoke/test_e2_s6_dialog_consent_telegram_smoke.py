...
class _DialogProvider:
    ...
    def __init__(self, session_key: str, page_handle: str, dialog_id: str) -> None:
        # `session_id`, NOT `session_key` and NOT `conversation_id`: browser_dialog
        # declares required=["session_id", "action", "dialog_id"] — read from the
        # live registry. This comment used to name conversation_id and was wrong. This
