...
def test_schedule_interval_seconds_rejects_malformed_daily_body() -> None:
...
def test_schedule_interval_seconds_accepts_clean_daily() -> None:
    assert schedule_interval_seconds("daily@09:00") == 86400.0


def test_schedule_interval_seconds_rejects_out_of_range_hour() -> None:
