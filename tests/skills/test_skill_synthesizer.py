...
# ---------- retirement lives in SkillCurator now (D09.3 X11) ---------------
#
# The flat-threshold deprecate test and the six Story 3.5 owl-drive advisory
# tests that stood here MOVED to tests/skills/test_curator_quality_trigger.py,
# rewritten against lifecycle_state rather than a directory move. They were
# migrated rather than deleted: every guarantee they made still holds, and the
# owl-drive arithmetic they pin down is the same arithmetic, now living in
# owls.skill_ownership.owl_drive_thresholds.
