/**
 * cli.ts — TUI Channel Adapter (main CLI adapter).
 *
 ...
 * - wireToolNarration from cli-v1 is intentionally NOT used here — tool events come via emit()
...
export class CliAdapter implements ChannelAdapter {
  ...
  private readonly _channelId = "cli";
