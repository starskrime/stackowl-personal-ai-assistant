...
# Bump to a few hundred (not 8192 — pre-deliver hot path) if the box's fast tier
# thinks; this is a deployment-specific tuning knob, not something to solve here.
_MAX_TOKENS = 4
