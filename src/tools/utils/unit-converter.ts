...
const CONVERSIONS: Record<string, ConversionMap> = {
  length: {
    m: { km: 0.001, cm: 100, mm: 1000, mi: 0.000621371, ft: 3.28084, in: 39.3701, yd: 1.09361, nm: 1852000000 },
    ...
    ft: { m: 0.3048, cm: 30.48, in: 12, yd: 0.333333, mi: 0.000189394, km: 0.0003048 },
  ...
  weight: {
    kg: { g: 1000, mg: 1000000, lb: 2.20462, oz: 35.274, ton: 0.001, st: 0.157473 },
  ...
  volume: {
    l: { ml: 1000, gal: 0.264172, qt: 1.05669, pt: 2.11338, cup: 4.22675, fl_oz: 33.814, tbsp: 67.628, tsp: 202.884 },
    ml: { l: 0.001, fl_oz: 0.033814, tsp: 0.202884, tbsp: 0.067628, cup: 0.00422675 },
  ...
  area: {
    sqm: { sqft: 10.7639, sqkm: 0.000001, acre: 0.000247105, ha: 0.0001, sqmi: 3.861e-7 },
  ...
  time: {
    s: { ms: 1000, min: 1 / 60, hr: 1 / 3600, day: 1 / 86400, week: 1 / 604800 },
